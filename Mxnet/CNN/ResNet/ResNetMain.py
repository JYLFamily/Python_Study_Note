...
from Mxnet.CNN.ResNet.ResNet import ResNet


class ResNetMain(object):
    ...
    def function_set(self):
        self.__net = ResNet(num_classes=10)
...
if __name__ == "__main__":
    rnm = ResNetMain(batch_size=64, learning_rate=0.1, epochs=10)
    rnm.set_ctx()
    rnm.data_prepare()
    rnm.function_set()
    rnm.goodness_of_function_loss_function()
    rnm.goodness_of_function_optimizer_data()
    rnm.goodness_of_function_optimizer_function()
    rnm.pick_the_best_function()