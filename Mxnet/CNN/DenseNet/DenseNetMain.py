...
from Mxnet.CNN.DenseNet.DenseNet import dense_net


class DenseNetMain(object):
...
if __name__ == "__main__":
    dnm = DenseNetMain(batch_size=64, learning_rate=0.1, epochs=10)
    dnm.set_ctx()
    dnm.data_prepare()
    dnm.function_set()
    dnm.goodness_of_function_loss_function()
    dnm.goodness_of_function_optimizer_data()
    dnm.goodness_of_function_optimizer_function()
    dnm.pick_the_best_function()