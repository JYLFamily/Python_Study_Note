...
class AdamGluon(object):
    def __init__(self, *, batch_size, learning_rate, gamma1, epochs):
        # data prepare
        self.__num_inputs = 2
...
if __name__ == "__main__":
    ag = AdamGluon(batch_size=10, learning_rate=0.03, gamma1=0.9, epochs=10)
    ag.data_prepare()
    ag.function_set()
    ag.goodness_of_function_loss_function()
    ag.goodness_of_function_optimizer_data()
    ag.goodness_of_function_optimizer_function()
    ag.pick_the_best_function()
