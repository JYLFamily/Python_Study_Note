...
class GradientDescentScratch(object):
...
if __name__ == "__main__":
    gds = GradientDescentScratch(batch_size=1, learning_rate=0.2, epochs=5)
    gds.data_prepare()
    gds.function_set()
    gds.goodness_of_function_loss_function()
    gds.goodness_of_function_optimizer_data()
    gds.goodness_of_function_optimizer_function()
    gds.pick_the_best_function()
